...
const buttonStyles = tv({
  ...
  variants: {
    varinat: {
      primary:
        "border border-transparent bg-linear-to-b from-zinc-700 to-zinc-800 text-white text-shadow-xs hover:to-zinc-700 dark:border-b-zinc-600 dark:from-zinc-600 dark:to-zinc-700 dark:inset-shadow-white/20 dark:hover:to-zinc-600",
      secondary:
